...
/**
 * This is the model class for table "person_price".
 *
 * The followings are the available columns in table 'person_price':
 * @property string $id
 ...
 */
class PersonPrice extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PersonPrice the static model class
	 */
