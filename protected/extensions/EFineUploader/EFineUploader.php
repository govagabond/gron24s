...
class EFineUploader extends CWidget
{
	...
	public $css=null;
		...
		$assets = dirname(__FILE__).'/assets';
                ...
                $fJs=(YII_DEBUG)?$baseUrl."/scripts/jquery.fineuploader-{$this->version}.js":$baseUrl."/jquery.fineuploader-{$this->version}.min.js";
                Yii::app()->clientScript->registerScriptFile($fJs, CClientScript::POS_HEAD);

                $this->css=(!empty($this->css))?$this->css:$baseUrl."/css/fineuploader-{$this->version}.css";
