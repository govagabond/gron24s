...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	public $scope = "email, user_about_me, user_birthday, user_location,user_hometown, user_website, read_stream, offline_access, publish_stream, read_friendlists";
	...
	*/
	function loginBegin()
	{
		$parameters = array("scope" => $this->scope, "redirect_uri" => 'http://localhost'.$this->endpoint, "display" => "page");
